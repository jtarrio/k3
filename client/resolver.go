...
// ClientHandleResolver returns a function that takes a handle and returns its DID, if it exists.
//
// You can use this function with importers to link usernames to their profiles.
func ClientHandleResolver(client Client) func(handle string) *string {
